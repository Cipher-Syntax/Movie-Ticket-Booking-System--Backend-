<?php
    ...
    $queries = [
        'nowShowing' => "SELECT * FROM movies WHERE status = 'Now Showing' AND cinema_number = 4 $searchCondition",
        'popular' => "SELECT * FROM movies WHERE status = 'Popular Movies' AND cinema_number = 4 $searchCondition",
        'comingSoon' => "SELECT * FROM movies WHERE status = 'Coming Soon' AND cinema_number = 4 $searchCondition"
    ];
