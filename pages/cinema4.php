<?php
    ...
    // Fetch movies
    $nowShowingQuery = "SELECT * FROM movies WHERE status = 'Now Showing' AND cinema_number = 4 $searchCondition";
    $popularQuery = "SELECT * FROM movies WHERE status = 'Popular Movies' AND cinema_number = 4 $searchCondition";
    $comingSoonQuery = "SELECT * FROM movies WHERE status = 'Coming Soon' AND cinema_number = 4 $searchCondition";
